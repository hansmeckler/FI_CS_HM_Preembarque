...
<div class="view">
	...
	<?php echo CHtml::link(CHtml::encode($data->id_routing), array('view', 'id'=>$data->id_routing,'asDialog'=>$_GET['asDialog'])); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('bl_id_fecha')); ?>:</b>
	<?php echo CHtml::encode($data->bl_id_fecha); ?>
	<br />
