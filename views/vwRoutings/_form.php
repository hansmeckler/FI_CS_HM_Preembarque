...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'id_catalogo'); ?>
		<?php echo $form->textField($model,'id_catalogo'); ?>
		<?php echo $form->error($model,'id_catalogo'); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textArea($model,'import_export',array('rows'=>6, 'cols'=>50)); ?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'nombre_transporte'); ?>
		<?php echo $form->textField($model,'nombre_transporte',array('size'=>30,'maxlength'=>30)); ?>
		<?php echo $form->error($model,'nombre_transporte'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'nombre_creacion'); ?>
		<?php echo $form->textField($model,'nombre_creacion',array('size'=>48,'maxlength'=>48)); ?>
		<?php echo $form->error($model,'nombre_creacion'); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'nombre_cliente',array('size'=>60,'maxlength'=>150)); ?>
