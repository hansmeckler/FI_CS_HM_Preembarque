<?php
	...
	<p style='text-align:justify'>Si necesita mayor informaci&oacute;n de su carga puede visitar nuestro tracking en la pagina web: <a href='".$ro['webp_url']."'>{$ro['webp_tex']}</a> o bien consultar con nuestro departamento de Soporte a Ventas, {$ro['SetSupportName']} e-mail: {$ro['SetSupportEmail']} Telefono: {$ro['SetSupportPhone']}.</p>
